...
#
# Serves Reader's own documentation (README, CHANGELOG, docs/) — never a Companion
...
# rule); Reader's web UI has no Companion wiring today, so this is also the only
...
# documentation, nothing else. No Companion repository is ever mounted or baked
# into this image.
